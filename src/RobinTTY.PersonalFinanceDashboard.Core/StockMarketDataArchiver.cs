...
namespace RobinTTY.PersonalFinanceDashboard.Core;

public static class StockMarketDataArchiver
{
    public static async Task ImportHistoricalPrices()
    {
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // EXISTING DATA BEGIN: 08.03.2022 EXISTING DATA END 07.08.2022 (BOTH DATES INCLUDED)
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        var startDate = new DateTime(2022, 03, 08);
        var currentDate = startDate;
        var endDate = new DateTime(2022, 03, 08);
        ...
        foreach (var symbol in symbols)
        {
            ...
            {
                Console.WriteLine($"Downloading data for {currentDate}...");
