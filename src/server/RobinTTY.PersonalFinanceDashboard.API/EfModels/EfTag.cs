...
public class EfTag
{
    ...
    /// </summary>
    public ICollection<EfTransaction> Transactions { get; }

    /// <summary>
    /// Creates a new instance of <see cref="EfTag"/>.
    /// </summary>
    ...
    public EfTag(string id, string name, string description, string color)
    {
        Id = id;
        Name = name;
        Description = description;
        Color = color;
        Transactions = new List<EfTransaction>();
    }
}
